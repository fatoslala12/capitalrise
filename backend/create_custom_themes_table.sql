...
-- Create indexes
CREATE INDEX IF NOT EXISTS idx_custom_themes_employee_id ON custom_themes(employee_id);
...
INSERT INTO custom_themes (id, employee_id, name, colors, is_public) VALUES 
