...
router.get('/:contractId', verifyToken, controller.getExpensesByContract);
router.get('/:contract_number', controller.getExpensesByContract);
router.post('/', verifyToken, requireRole('admin'), controller.addExpense);
router.post('/:contract_number', controller.addExpenseForContract);
