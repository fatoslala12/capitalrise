  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        // Load contracts for site options
        axios.get("https://capitalrise-cwcq.onrender.com/api/contracts", {
          ...
          // Set employees with basic data (workplace will be handled by filtering)
    ...
    const filtered = employees
      .filter(emp => {
        ...
        if (filterWorkplace !== "All") {
          // Show all employees for now - workplace filtering can be added later
          matchesWorkplace = true;
        }
